(function(){
  ...
  function itemHTML(key, embedded){
    ...
    if (c.stage==='triage') {
      ...
      h += '<div class="m-stage"><div class="m-stage-lbl"><i></i><span>'+(c.hold?dave(c.hold):(allBaked(c)?'Ruled and filed — queued for the next build':'Groomed — ready to rule'))+'</span></div></div>';
