...
def toolbar(fixed):
    ...
    toggle = f'<span style="display: inline-flex; height: 36px; border: 1px solid #e2e8f0; border-radius: 6px; overflow: hidden; font-size: 14px; {"flex: none;" if fixed else "flex: none; min-width: 0;"}"><span style="padding: 0 12px; display: grid; place-items: center; background: #64748b; color: #fff; white-space: nowrap; flex: none;">Pipeline</span><span style="padding: 0 12px; display: grid; place-items: center; background: #fff; color: #475569; white-space: nowrap; {"" if fixed else "width: 22px; padding: 0 0 0 12px; overflow: hidden;"}">{"List" if fixed else "Li"}</span></span>'
