...
def deck_card(mark=None):
    m = f'<div style="margin-top:10px;display:flex;align-items:flex-start;gap:6px;font-size:12.5px;line-height:1.4;color:#92400e;background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:8px 10px;"><span style="flex:none;margin-top:1px;">{OF.TREND_UP if hasattr(OF,"TREND_UP") else ""}</span><span>{mark}</span></div>' if mark else ''
