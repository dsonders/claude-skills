...
DEC = {
 ...
 "Q": [
  ("Which variants go on the ballot — your three, plus which extras?", [("A","Your three only",False),("B","Your three + collapse the notes band",False),("C","Your three + the extras — notes band, part on one row, a per-user “Compact” setting",False)]),
